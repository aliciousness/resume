...
This is my resume website hosted on s3 with cloudfront. I created the resource to host this website using [Pulumi](https://www.pulumi.com/). The [repository](https://github.com/aliciousness/new_website).
